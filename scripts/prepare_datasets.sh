...
full_patch_source=../datasets_anime/APISR_dataset
...
tmp_dir_720p_4xcrop=APISR_720p_4xcrop_tmp
...
python scripts/anime_strong_usm.py -i $tmp_dir_720p_4xcrop -o $tmp_enhanced_dir --outlier_threshold 32 --num_workers 6
